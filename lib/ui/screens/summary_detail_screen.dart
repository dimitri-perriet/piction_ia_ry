...
class SummaryDetailScreen extends StatelessWidget {
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Stack(
                  children: [
                    Image.network(
                      'https://yourimageurl.com/image.png', // Remplacer par l'URL appropriée
              ...
              const SizedBox(height: 20),
              // Section des propositions faites
              const Text(
                'Propositions faites',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
              ),
  ...
  // Fonction pour afficher une proposition avec le score
